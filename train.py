...
def train(model):
    ...
    for epoch in range(cfg.EPOCH_NUMBER):
        ...
        for i, sample in enumerate(train_data):
            ...
            if i % 5 == 0:
                print("batch: {}/{}, loss: {}".format(i, len(train_data), loss.item()))

        if best > train_loss / len(train_data):
            best = train_loss / len(train_data)
            t.save(net.state_dict(), "./models/best.pth")
